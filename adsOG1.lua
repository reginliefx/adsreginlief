...
local t = {"Tengoku Raid", "Hirito Raid", "Titan Raid", "Esper Raid", "Demon Lord Raid", "Yomiichi Raid", "Christmas Raid", "Combat Titan Raid", "Infinity Nojo Raid", "Gear 5 Fluffy Raid", "Nardo Beast Raid", "Cursed Sage Raid", "Red Emperor Raid", "Tengu Raid", "Vio Raid", "Ichini Fullbring Raid", "Tanjiro Sun God Raid", "Black Pasta Raid", "Cosmic Wolfman Raid","Joto Raid"}
...
E:AddToggle(
    {
        Name = "Skill 5",
        Default = _G.Settings.AutoAwakened,
        Color = Color3.fromRGB(255,215,0),
        Callback = function(H)
            _G.Settings.AutoAwakened = H
            saveSettings()
            task.spawn(
                function()
                    while task.wait(_G.Settings.skilldelay) do
                        if not _G.Settings.AutoAwakened then
                            break
                        end
                        for m, n in pairs(
                            getconnections(
...
E:AddToggle(
    {
        Name = "Fruit Z",
        Default = _G.Settings.AutoSkillFruitZ,
        Color = Color3.fromRGB(255,215,0),
        Callback = function(H)
            _G.Settings.AutoSkillFruitZ = H
            saveSettings()
            task.spawn(
                function()
                    while task.wait(_G.Settings.skilldelay) do
                        if not _G.Settings.AutoSkillFruitZ then
                            break
                        end
                        for m, n in pairs(
                            getconnections(
...
E:AddToggle(
    {
        Name = "Fruit X",
        Default = _G.Settings.AutoSkillFruitX,
        Color = Color3.fromRGB(255,215,0),
        Callback = function(H)
            _G.Settings.AutoSkillFruitX = H
            saveSettings()
            task.spawn(
                function()
                    while task.wait(_G.Settings.skilldelay) do
                        if not _G.Settings.AutoSkillFruitX then
                            break
                        end
                        for m, n in pairs(
                            getconnections(
...
G:AddLabel("LastestUpdate : 1/1/2024 ")

u:MakeNotification({Name = "Reginlief", Content = "Game: Anime Dimension", Time = 15})
u:Init()
